...
String _passwordVersion = 'Unknown';
  ...
  Future<void> emailPlatformState() async {
    ...
    try {
      //platformVersion =  await Flutterlogin.platformVersiondata;
      platformVersion =  await Flutterlogin.emailValidation(_emailtext.text);
       setState(() {
  ...
  Future<void> validPlatformState() async {
    ...
    try {
      //platformVersion =  await Flutterlogin.platformVersiondata;
      email =  await Flutterlogin.emailValidation(_emailtext.text);
      password =  await Flutterlogin.passwordValidation(_passwordtext.text);
   ...
   Future<void> passwordPlatformState() async {
    ...
    try {
      //platformVersion =  await Flutterlogin.platformVersiondata;
      platformVersion =  await Flutterlogin.passwordValidation(_passwordtext.text);
       setState(() {
